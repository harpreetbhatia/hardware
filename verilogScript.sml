...
val erun_cmp_def = Define `
 ...
 (erun_cmp LessThan l r = sum_bind (ver2n l) (\ln. (* <-- same as wordsTheory.word_lt, i.e. signed less than *)
                          sum_bind (ver2n r) (\rn.
                          sum_bind (ver_msb l) (\lmsb.
                          sum_for (ver_msb r) (\rmsb.
                          (lmsb = rmsb) /\ ln < rn \/ lmsb /\ ~rmsb))))) /\
 (erun_cmp LowerThan l r = sum_bind (ver2n l) (\l. (* <-- same as wordsTheory.word_lo, i.e. unsigned less than *)
                           sum_for (ver2n r) (\r.
                           l < r)))`;
